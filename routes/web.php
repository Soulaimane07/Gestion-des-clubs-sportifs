...
Route::middleware(['auth'])->group(function(){
    ...
    Route::get('/playerCard', function () {
        $pdf = App::make('dompdf.wrapper');
        $pdf->loadView('PDF/player');
        return $pdf->download('player.pdf');
    });

Route::get('/playersCard/{id}', [PdfController::class, 'PlayersCardsPDF']);
Route::get('/playersTable/{id}', [PdfController::class, 'PlayerstablePDF']);
